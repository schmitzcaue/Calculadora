...
uma calculadora um console simples que permite realizar as quatro operações, além de vizualizar a tabuada e o histórico de operções.

## funcionalidades

- **Operações Básicas:** Realize somas, sub, multi e div com facilidade.
